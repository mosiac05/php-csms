  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <?php
        $resolved_id = $_GET['view_single_resolved'];
        ...
        echo "<tr><th>ATTACHMENT</th><td><img src='attachment/{$resolved_attachment}' width='100' alt='{$resolved_attachment}'></td></tr>";
        } else{
        ...
        ?>
          ...
          <div class="row">
            <div class="col-md-12">
              <!-- DIRECT CHAT -->
              <div class="box solid-box box-warning direct-chat direct-chat-warning">
                <div class="box-header with-border">
