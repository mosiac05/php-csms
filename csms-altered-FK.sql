...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2020 at 10:28 AM
...
(1, 'John Bob', 'john.bob@gmail.com', 'eaea7928d3c0c10ce80be4f79222981b', 'S11P003789', '09000000123', 'Profile Pic.jpg', 'Kwara', 'Ilorin', 'No. 3 Sateri Street, Oku', '300415', 'ACTIVATED', '2020-05-02 22:01:40', '2020-05-19 11:42:05', 4),
(2, 'Teslima Rahman', 'Teslima.Rahman@gmail.com', '05061a1b05b121ff2d31efdc78852284', 'S11P222429', '08022259867', 'avatar.png', 'Osun', 'Ede', 'Ayola Street', '300415', 'ACTIVATED', '2020-05-02 21:56:45', '2020-05-19 11:42:06', 3),
(4, 'Enemali Onah', 'enemali.onah@gmail.com', '2990da177b17912355694881352ae494', 'S11P003789', '08143547213', 'avatar.png', 'Kwara', 'Ilorin', 'Aweye Building, Ilodun Street, Tanke', '300415', 'DEACTIVATED', '2020-05-02 21:45:24', '2020-05-19 11:42:06', 1),
(5, 'Omto Chine', 'omto.chine@gmail.com', 'e595139b9b1500bc67b0c3cc7867a32b', '', '08143546590', 'avatar.png', 'Osun', 'Otewu', 'Irani County, Ogun', '300415', 'DEACTIVATED', '2020-05-02 21:45:32', '2020-05-19 11:42:06', 1),
(7, 'Emmanuel Rose', 'em.rose@gmail.com', '38b58483cf2d2651d95abb1db676b24f', 'S12B002629', '09087654321', 'avatar.png', 'Nassarawa', 'Mararaba', 'Abuja-Keffi Express Way', '300415', 'DEACTIVATED', '2020-05-02 21:45:39', '2020-05-19 11:42:06', 2),
...
INSERT INTO `password_reset_temp` (`id`, `email_address`, `token_key`, `expDate`, `role`) VALUES
(1, 'obutemoses5@gmail.com', '89y9ugo', '2020-05-17 18:00:00', 'customer');
...
(1, 'Emma Melu', '200156', 'emma.melu@gmail.com', '09099990009', 'df2d555b4589e722ad83af64e978596c', 'IMG_1078.JPG', '300415', 'ACTIVATED', 3, '2020-05-02 21:18:34', '2020-05-19 11:59:29'),
(2, 'Ruth Hart', '300415', 'ruth.hart@gmail.com', '09021564778', '66266e1d2f3c32e9b3f21f116aba5f84', 'avatar.png', '300415', 'ACTIVATED', 1, '2020-05-02 21:17:00', '2020-05-19 12:26:32'),
(3, 'Turgis Kara', '300976', 'turgis.kara@gmail.com', '09000000000', '075d30229d8598dc1c065bfe0a693cc5', 'avatar.png', '300415', 'ACTIVATED', 3, '2020-05-02 20:44:09', '2020-05-19 11:59:43'),
(4, 'Peter Uli', '200531', 'peter.uli@gmail.com', '09087654321', 'f52396b16889e114992ee16fbafe6447', 'IMG_1201.JPG', '300415', 'DEACTIVATED', 3, '2020-05-02 20:53:17', '2020-05-19 11:59:49'),
...
ALTER TABLE `customers`
  ...
  ADD KEY `customer_creator` (`customer_creator`),
...
ALTER TABLE `requests`
  ...
  ADD KEY `customer_id` (`customer_id`),
  ADD KEY `workteam_id` (`workteam_id`),
  ADD KEY `request_assignee` (`request_assignee`),
  ADD KEY `request_cat_id` (`request_cat_id`);
...
ALTER TABLE `staffs`
  ...
  ADD KEY `staff_creator` (`staff_creator`);
...
ALTER TABLE `workteams`
  ...
  ADD KEY `workteam_head` (`workteam_head`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`request_id`) REFERENCES `requests` (`request_id`),
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`),
  ADD CONSTRAINT `comments_ibfk_3` FOREIGN KEY (`staff_id`) REFERENCES `staffs` (`staff_id`);

--
-- Constraints for table `customers`
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`customer_creator`) REFERENCES `staffs` (`staff_code`),
  ADD CONSTRAINT `customers_ibfk_2` FOREIGN KEY (`area_id`) REFERENCES `areas` (`area_id`);

--
-- Constraints for table `notes`
--
ALTER TABLE `notes`
  ADD CONSTRAINT `notes_ibfk_1` FOREIGN KEY (`staff_code`) REFERENCES `staffs` (`staff_code`);
...
ALTER TABLE `requests`
  ...
  ADD CONSTRAINT `requests_ibfk_2` FOREIGN KEY (`workteam_id`) REFERENCES `workteams` (`workteam_id`),
  ADD CONSTRAINT `requests_ibfk_3` FOREIGN KEY (`request_assignee`) REFERENCES `staffs` (`staff_code`),
  ADD CONSTRAINT `requests_ibfk_4` FOREIGN KEY (`request_cat_id`) REFERENCES `request_cats` (`request_cat_id`);
...
ALTER TABLE `staffs`
  ...
  ADD CONSTRAINT `staffs_ibfk_2` FOREIGN KEY (`staff_creator`) REFERENCES `staffs` (`staff_code`);

--
-- Constraints for table `workteams`
--
ALTER TABLE `workteams`
  ADD CONSTRAINT `workteams_ibfk_1` FOREIGN KEY (`workteam_head`) REFERENCES `staffs` (`staff_id`);
...
ALTER TABLE `workteam_members`
  ...
  ADD CONSTRAINT `workteam_members_ibfk_2` FOREIGN KEY (`workteam_id`) REFERENCES `workteams` (`workteam_id`);
COMMIT;
